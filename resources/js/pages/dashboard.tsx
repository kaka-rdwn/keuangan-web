        ...
        <>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 overflow-x-auto rounded-xl p-4 md:p-6">
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                            Ringkasan performa finansial, tren arus kas, dan
                        ...
                        <CardContent>
                            {metrics.top_expense_category ? (
                                <>
                                    ...
                                    <p className="pt-1 text-xs font-semibold text-rose-600 dark:text-rose-400">
                                        {formatRupiah(
                                            metrics.top_expense_category.amount,
                                        )}
                                    </p>
                                </>
                            ) : (
                ...
                <div className="grid gap-6 lg:grid-cols-7">
                    {/* Left: Bar Chart */}
                    <Card className="border-sidebar-border/70 lg:col-span-4 dark:border-sidebar-border">
                    ...
                    <Card className="border-sidebar-border/70 lg:col-span-3 dark:border-sidebar-border">
                        <CardHeader>
                            <CardTitle className="text-base font-semibold">
                        ...
                        <CardContent className="flex flex-col items-center justify-center">
                            {category_distribution.length > 0 ? (
                                <div className="flex h-[300px] w-full flex-col items-center">
                                    ...
                                    <div className="max-h-[100px] w-full space-y-1 overflow-y-auto pt-2 text-xs">
                                        {category_distribution
                                            .slice(0, 4)
                                            .map((item, idx) => (
                                                <div
                    ...
                    <CardHeader className="flex flex-row items-center justify-between">
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground">
                                5 transaksi keuangan yang baru saja dicatat.
                            </p>
                        </div>
                        <Button
                            variant="ghost"
                                    ...
                                    {recent_transactions.length > 0 ? (
                                        recent_transactions.map((item) => (
                                            ...
                                            >
                                                ...
                                                <td className="px-4 py-2.5">
                                                    {item.type === 'inflow' ? (
                                                        <Badge className="border-emerald-200 bg-emerald-100 py-0 text-[10px] text-emerald-800 hover:bg-emerald-100 dark:border-emerald-800 dark:bg-emerald-950 dark:text-emerald-300">
                                                            Pemasukan
                                                        </Badge>
                                                    ) : (
                                                        <Badge className="border-rose-200 bg-rose-100 py-0 text-[10px] text-rose-800 hover:bg-rose-100 dark:border-rose-800 dark:bg-rose-950 dark:text-rose-300">
                                                            Pengeluaran
                                                        </Badge>
                                                    )}
                                                </td>
