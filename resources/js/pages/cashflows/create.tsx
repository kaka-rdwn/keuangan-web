        ...
        <>
            ...
            <div className="mx-auto max-w-3xl space-y-6 px-4 py-6 sm:px-6 lg:px-8">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                            Buat pencatatan transaksi pemasukan atau pengeluaran baru.
                        </p>
                    </div>
                </div>
                ...
                <Card className="border-sidebar-border/70 dark:border-sidebar-border">
                    <CardHeader>
                        <CardTitle className="text-lg font-semibold">Formulir Transaksi Baru</CardTitle>
                        <CardDescription>
                            Lengkapi rincian nominal, tanggal, dan kategori transaksi di bawah ini.
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
