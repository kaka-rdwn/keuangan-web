...
export default function CashflowsIndex({
    ...
    const [deletingCashflow, setDeletingCashflow] = useState<Cashflow | null>(
        null,
    );
                ...
                <div className="grid gap-4 md:grid-cols-3">
                    ...
                    <Card className="border-rose-200 bg-rose-50/50 dark:border-rose-900/50 dark:bg-rose-950/20">
                        ...
                        <CardContent>
                            ...
                            <p className="pt-1 text-xs text-muted-foreground">
                                Total uang keluar terakumulasi
                            </p>
                        </CardContent>
                    </Card>
                    ...
                    <CardHeader className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground">
                                Catat dan pantau transaksi pemasukan serta
                    ...
                    <CardContent className="space-y-4">
                        ...
                        {cashflows.links.length > 3 && (
                            <div className="flex flex-wrap items-center justify-between gap-2 pt-2 text-sm text-muted-foreground">
                                <div>
                                    Menampilkan {cashflows.from ?? 0} hingga{' '}
                                    {cashflows.to ?? 0} dari {cashflows.total}{' '}
                                    transaksi
                                </div>
                ...
                <DialogContent className="sm:max-w-[400px]">
                    ...
                    <DialogFooter className="gap-2 sm:gap-0">
                        <Button
                            type="button"
                            variant="outline"
                            onClick={() => setDeletingCashflow(null)}
                        >
                            Batal
                        </Button>
                        <Button
