...
{
    /**
     * Menentukan apakah pengguna memiliki otoritas untuk membuat transaksi arus kas.
     */
    public function authorize(): bool
    {
        return Gate::allows('cashflow.create');
    }

    /**
     * Mendapatkan aturan validasi yang berlaku untuk permintaan pencatatan transaksi arus kas.
     *
